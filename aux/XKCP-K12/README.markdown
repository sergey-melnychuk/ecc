COPY OF: https://github.com/XKCP/K12/tree/f95b0b73e29fe75fe99fbbb24c8000d9fcf0b40e

```bash
git clone https://github.com/XKCP/K12.git && cd K12
git submodule update --init --recursive

make ARMv8Asha3/libKT.a
#make plain64/libKT.a

sudo cp bin/ARMv8Asha3/libKT.a /usr/local/lib/libk12.a
sudo cp lib/KangarooTwelve.h /usr/local/include/
```
